...
public class GoogleMapsActivity extends AppCompatActivity implements MapsToCabInterface {
...
//        navDrawerItems.add(new NavDrawerItem(navMenuTitles[5], navMenuIcons.getResourceId(5, -1), true, "50+"));
    ...
    public void communicate() {
        ...
        ft.replace(R.id.drawer_layout, new CabsListFragment())
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                fragment = new CabsListFragment();
                break;
            case 3:
                fragment = new FragmentDriversList();
                break;
            case 4:
